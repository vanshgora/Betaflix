...
export default function IntroSecAcorr() {
    return (
        <div className='accor-sec'>
            ...
            <div className="accordion bg-black accor" id="accordionExample">
                <div className="accordion-item my-2 accor-item bg-black">
                    <h2 className="accordion-header">
                        <button className="accordion-button mb-1 accor-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            What is Betaflix?
                        </button>
                    </h2>
                ...
                <div className="accordion-item my-2 accor-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button collapsed accor-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                ...
                <div className="accordion-item my-2 accor-item">
                    <h2 className="accordion-header bg-dark">
                        <button className="accordion-button collapsed accor-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            Where can I watch?
                        </button>
                    </h2>
                ...
                <div className="accordion-item my-2 accor-item">
                    <h2 className="accordion-header bg-dark">
                        <button className="accordion-button collapsed accor-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            How do can I cancle?
                        </button>
                    </h2>
                ...
                <div className="accordion-item my-2 accor-item">
                    <h2 className="accordion-header bg-dark">
                        <button className="accordion-button collapsed accor-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                ...
                <div className="accordion-item my-2 accor-item">
                    <h2 className="accordion-header bg-dark">
                        <button className="accordion-button collapsed accor-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
